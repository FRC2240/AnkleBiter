      ...
      magnet_offset{magnet_offset}
{
    ...
    //driver_config.statorCurrLimit = ctre::phoenix::motorcontrol::StatorCurrentLimitConfiguration {true, 70, 70, 0.5};
    //driver_config.supplyCurrLimit = ctre::phoenix::motorcontrol::SupplyCurrentLimitConfiguration {true, 70, 70, 0.5};
    //;
